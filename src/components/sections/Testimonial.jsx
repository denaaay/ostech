...
function Testimonial() {
    ...
    return(
        <div className='w-full h-max pt-32 flex justify-center'>
            <div className="w-[75vw] h-max flex flex-col justify-center items-center gap-10">
                ...
                {/* Testimonial Content */}
                <div ref={divRef} className="w-full h-max flex justify-between items-start gap-8">
                    <div className="flex-1 h-max p-8 bg-[#2b2b2b] rounded-lg flex flex-col justify-between items-start gap-8">
                        <div className="w-full h-max flex flex-col items-start gap-2">
                            ...
                            <p className='font-primaryFont text-white text-xl text-justify'>The team at Orange Sphere Technology is incredibly professional and responsive. Our project was completed on time, and the results exceeded our expectations!"</p>
                        </div>
                    ...
                    <div className="flex-1 p-8 bg-[#2b2b2b] rounded-lg flex flex-col justify-between items-start gap-8" style={{ height: divHeight }}>
                        <div className="w-full h-max flex flex-col items-start gap-2">
                            <div className="w-full h-max">
                                <img src={Star} alt="stars.png" className='w-[35%] h-full object-cover'/>
                            </div>
                    ...
                    <div className="flex-1 h-max p-8 bg-[#2b2b2b] rounded-lg flex flex-col justify-between items-start gap-8" style={{ height: divHeight }}>
                        <div className="w-full h-max flex flex-col items-start gap-2">
                            <div className="w-full h-max">
                                <img src={Star} alt="stars.png" className='w-[35%] h-full object-cover'/>
                            </div>
                            <p className='font-primaryFont text-white text-xl text-justify'>Working with Orange Sphere Technology has been an outstanding experience. They truly listened to our needs and delivered the right solutions.</p>
                        </div>
