            ...
            <div className="w-[75vw] h-max flex flex-col justify-center items-center gap-10 mp:w-[90vw]">
                ...
                <div className="w-full h-max flex justify-between items-start mp:flex-col mp:gap-10">
                    ...
                    <div className="flex-1 h-max flex flex-col mp:flex-row mp:gap-6">
                        <div className="w-full h-max flex flex-col justify-center items-center font-secondaryFont text-4xl mp:text-xl mp:items-start mp:w-max">
                            <p>website</p>
                            <p>development</p>
                        </div>

                        <div ref={divRef} className="w-full h-max px-12 py-10 font-primaryFont text-2xl text-justify leading-10 mp:p-0 mp:leading-8 mp:font-thin mp:text-lg">
                    ...
                    <div className="flex-1 h-max flex flex-col mp:flex-row mp:gap-6">
                        ...
                        <div className="w-full px-12 py-10 font-primaryFont text-2xl text-justify leading-10 border-white border-l-[2px] border-r-[2px] mp:border-none mp:p-0 mp:leading-8 mp:font-thin mp:text-lg" style={{ height: divHeight }}>
                    ...
                    <div className="flex-1 h-max flex flex-col mp:flex-row mp:gap-6">
                        ...
                        <div className="w-full h-max px-12 py-10 font-primaryFont text-2xl text-justify leading-10 mp:p-0 mp:leading-8 mp:font-thin mp:text-lg">
