        ...
        <div className="w-full h-max pt-32 flex justify-center mp:pt-16" id={props.id} ref={ref}>
            <div className="w-[75vw] h-max flex flex-col gap-8 mp:w-[90vw] mp:gap-10">
                ...
                <div className="w-full h-max flex flex-col items-start bg-[#2B2B2B] rounded-xl p-8 gap-8 mp:p-4 mp:gap-4">
                    <p className="font-secondaryFont text-white text-5xl mp:text-[40px]">About Us<span className="text-secondaryColor">.</span></p>
                    <div className="w-full h-max flex flex-col gap-4 font-primaryFont text-white text-2xl text-justify mp:text-lg">
                        ...
                        <p className="mp:hidden">Driven by innovation and powered by a collaborative spirit, Orange Sphere Technology is here to elevate your digital experience and help your business succeed in today’s competitive market.</p>
                    </div>
                </div>
