...
function Footer() {
    ...
    return(
        <div className="w-screen h-max bg-[#2B2B2B] px-32 py-12 flex flex-col gap-16 mp:p-6 mp:gap-10">
            {/* Header Footer */}
            <div className="w-full h-max flex justify-between items-center mp:flex-col mp:gap-8">
                <div className='w-max h-[50px] mp:h-[40px]'>
                    <img src={OstechIcon} alt="ostechIcon.png" className='w-full h-full object-cover'/>
                </div>
                <div className='w-max h-max flex items-center text-xl gap-16 flex justify-center text-white font-thin mp:gap-8'>
            ...
            <div className='w-full h-max flex justify-between items-center mp:gap-8'>
                <div className='w-full h-max flex flex-col items-start gap-4 font-primaryFont text-3xl text-white mp:text-xl mp:gap-1 mp:w-max'>
                ...
                {/* Follow Icon */}
                <div className='w-full h-max flex flex-col items-end gap-4 font-primaryFont text-3xl text-secondaryColor mp:gap-2 mp:text-xl mp:w-max'>
                    <p>Follow Us</p>
                    <div className='w-max h-max flex gap-4 mp:gap-2'>
                        <div className='w-[40px] cursor-pointer opacity-50 hover:opacity-100 mp:w-[30px] mp:h-max' onClick={() => {handleClick('ig')}}>
                            <img src={IconInstagram} alt="iconInstagram.png" className='w-full h-full object-cover'/>
                        </div>
                        <div className='w-[40px] cursor-pointer opacity-50 hover:opacity-100 mp:w-[30px] mp:h-max' onClick={() => {handleClick('wa')}}>
